    ...
    <>
      {path && (
        <svg
          ...
          version='1.1'
          className='pointer-events-none absolute inset-0 size-full w-full h-full'
        >
          <circle
...
const AnimatedForm = memo(function AnimatedForm({
  ...
  return (
    <section className='max-md:w-full flex flex-col gap-4 w-[384px] mx-auto'>
      ...
      {googleLogin && (
        <>
          ...
          >
            <button
              className='g-button group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-hidden hover:cursor-pointer relative overflow-hidden'
              type='button'
              onClick={() => console.log('Google login clicked')}
            >
              <span className='flex relative z-10 items-center justify-center w-full h-full gap-3 text-white'>
                <img
              ...
              >
                <section className='relative'>
                  {field.type !== 'select' ? (
                    ...
                    <select
                      id={field.label}
                      className="shadow-input flex h-10 w-full rounded-md border-none px-3 py-2 text-sm text-black transition duration-400 focus-visible:outline-none dark:bg-zinc-800 dark:text-white dark:shadow-[0px_0px_1px_1px_#404040]"
        ...
        >
          <button
            ...
            dark:text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] 
              dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset] outline-hidden hover:cursor-pointer overflow-hidden'
            type='submit'
          >
...
const BottomGradient = () => {
  return (
    <>
      <span className='group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0 bg-gradient-to-r from-transparent via-cyan-500 to-transparent z-20' />
      <span className='group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-1/2 mx-auto -bottom-px inset-x-10 bg-gradient-to-r from-transparent via-indigo-500 to-transparent z-20' />
    </>
  );
};
