      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <div key={s.label} className="bg-slate-900/50 border border-white/5 rounded-xl p-4 relative cursor-default">
              <div className="text-xs text-slate-500 uppercase tracking-wider mb-1 flex justify-between">
                {s.label}
                {(s as any).onAdd && (
                   <button onClick={(s as any).onAdd} className="text-[10px] bg-slate-800 text-slate-300 hover:text-white px-1.5 py-0.5 rounded border border-white/10" title="Add Manually">+ Add</button>
                )}
              </div>
