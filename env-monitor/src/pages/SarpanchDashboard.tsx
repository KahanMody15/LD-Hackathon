...
import { ArrowLeft, Activity, Bell, RadioTower, AlertTriangle, CheckCircle, XCircle, Users, LogOut, TrendingUp, CheckCircle2 } from "lucide-react";
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "Welfare":
        return (
          <div className="space-y-4 animate-in fade-in duration-300">
            <h3 className="text-lg font-bold text-white mb-4">Welfare & Relief Schemes</h3>
            
            <div className="bg-[#0D1322] border border-[#1A2234] rounded-2xl p-5 shadow-lg">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h4 className="font-bold text-gray-100 text-base">Clean Village Initiative</h4>
                  <p className="text-xs text-gray-400 mt-1">Budget: ₹2.4L · 1,240 beneficiaries</p>
                </div>
                <span className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold px-3 py-1 rounded-md">Active</span>
              </div>
              <div className="relative w-full h-2 bg-[#1A2234] rounded-full overflow-hidden mb-2">
                <div className="absolute top-0 left-0 h-full bg-orange-400 rounded-full" style={{ width: '60%' }} />
              </div>
            ...
            <div className="bg-[#0D1322] border border-[#1A2234] rounded-2xl p-5 shadow-lg">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h4 className="font-bold text-gray-100 text-base">Women & Child Health Drive</h4>
                  <p className="text-xs text-gray-400 mt-1">Budget: ₹1.1L · 680 beneficiaries</p>
                </div>
                <span className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold px-3 py-1 rounded-md">Active</span>
              </div>
              <div className="relative w-full h-2 bg-[#1A2234] rounded-full overflow-hidden mb-2">
                <div className="absolute top-0 left-0 h-full bg-orange-400 rounded-full" style={{ width: '75%' }} />
              </div>
              <div className="flex justify-between text-[11px] text-gray-500 font-medium">
                <span>Progress</span>
                <span>75%</span>
            ...
            <div className="bg-[#0D1322] border border-[#1A2234] rounded-2xl p-5 shadow-lg opacity-70">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h4 className="font-bold text-gray-100 text-base">Pollution Shield Kit Distribution</h4>
                  <p className="text-xs text-gray-400 mt-1">Budget: ₹80K · 0 beneficiaries</p>
                </div>
                <span className="bg-gray-500/10 border border-gray-500/20 text-gray-400 text-xs font-bold px-3 py-1 rounded-md">Upcoming</span>
              </div>
              <div className="relative w-full h-2 bg-[#1A2234] rounded-full overflow-hidden mb-2">
                <div className="absolute top-0 left-0 h-full bg-orange-400 rounded-full" style={{ width: '0%' }} />
              </div>
              <div className="flex justify-between text-[11px] text-gray-500 font-medium">
                <span>Progress</span>
      ...
      case "Alerts":
        return (
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-5 flex items-start justify-between shadow-lg relative overflow-hidden">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <AlertTriangle className="w-4 h-4 text-red-400" />
                  <h4 className="font-bold text-gray-100">Gas Leak</h4>
                  <span className="bg-red-500/20 text-red-400 text-[10px] font-bold px-2 py-0.5 rounded-full">Critical</span>
                </div>
                <p className="text-gray-300 text-sm mb-2">Anomalous toxic gas levels detected in industrial zone.</p>
                <p className="text-xs text-gray-500">Location: 21.6090, 73.0107 · Radius: 4.6 km</p>
              </div>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-5 flex items-start justify-between shadow-lg relative overflow-hidden">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <AlertTriangle className="w-4 h-4 text-amber-500" />
                  <h4 className="font-bold text-gray-100">Gas Leak</h4>
                  <span className="bg-amber-500/20 text-amber-400 text-[10px] font-bold px-2 py-0.5 rounded-full">Medium</span>
                </div>
                <p className="text-gray-300 text-sm mb-2">Anomalous toxic gas levels detected in industrial zone.</p>
                <p className="text-xs text-gray-500">Location: 21.6426, 72.9975 · Radius: 3.9 km</p>
              </div>
              <button className="text-xs text-orange-400 hover:text-orange-300 font-semibold transition-colors mt-1">
                Broadcast Alert
              </button>
            ...
            <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-5 flex items-start justify-between shadow-lg relative overflow-hidden">
              <div className="flex-1">
                ...
                <p className="text-gray-300 text-sm mb-2">Anomalous toxic gas levels detected in industrial zone.</p>
                <p className="text-xs text-gray-500">Location: 21.6039, 73.0131 · Radius: 2.8 km</p>
              </div>
              <button className="text-xs text-orange-400 hover:text-orange-300 font-semibold transition-colors mt-1">
                Broadcast Alert
              </button>
        ...
        <div className="max-w-[1400px] mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-[#0D1322] border border-[#1A2234] rounded-2xl p-5 flex flex-col justify-between shadow-lg">
              ...
              <div className="mt-2">
                <span className="text-4xl font-extrabold text-orange-500">{pendingCount}</span>
